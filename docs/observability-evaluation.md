...
*Optional reading. The required documents are the README, ASSUMPTIONS.md and AI-USE.md; this one is the method and full results behind the README's key findings.*
...
*One thread in LangSmith: the seven model calls behind "Which bus routes gained or lost weekday trips from Summer 2026 to Fall 2026?", with the tool call, its SQL, and tokens and cost per turn.*
